      ...
      if (FindProc("glXGetGPUInfoAMD", aGetGPUInfoAMD)) {
        ...
        for (int i = 0; i < count; i++) {
...

          {
            ...
            int vendorSize = aGetGPUInfoAMD(id, 0x1F00 /* GLX_GPU_VENDOR_AMD */, GL_UNSIGNED_BYTE, stringSize, amdGpuVendor);
            if (vendorSize <= 0)
            {
          ...
          }
          {
            ...
            int rendererSize = aGetGPUInfoAMD(id, 0x1F01 /* GLX_GPU_RENDERER_STRING_AMD */, GL_UNSIGNED_BYTE, stringSize, amdRenderer);
            if (rendererSize <= 0)
            {
          ...
          }
          {
            ...
            int openGLVersionSize = aGetGPUInfoAMD(id, 0x1F02 /* GLX_GPU_OPENGL_VERSION_STRING_AMD */, GL_UNSIGNED_BYTE, stringSize, amdOpenGLVersion);
